...
const SidebarProvider = ({
  ...
  React.useEffect(() => {
    document.cookie = `${SIDEBAR_COOKIE_NAME}=${setOpenProp ? openProp : _open}; path=/; max-age=${SIDEBAR_COOKIE_MAX_AGE}`
...
const SidebarGroupLabel = ({
  ...
  return (
    <Comp
      ...
      className={cn(
        'text-sidebar-foreground/70 ring-sidebar-ring flex min-h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium outline-none transition-[margin,opa] duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0',
